...
async function installPayload(payload, options = {}) {
  ...
  try {
    ...
    emitProgress(report, { phase: "star", step: 1, titleFa: "بررسی سورس رسمی", titleEn: "checking official source" });
...
<div class="footer" data-fa="Lumen public installer" data-en="Lumen public installer">Lumen public installer</div>
</div>
...
(function(){
 ...
 var stepDefs=[['آزمایش مسیر مستقیم و همه پروکسی‌های رسمی','Test direct egress and all proxies'],['بررسی سورس رسمی','Star official source'],['ساخت یا بررسی فورک','Create or verify fork'],['کشف یا ساخت Workspace','Resolve or create workspace'],['ساخت پروژه Railway','Create Railway project'],['تنظیم متغیرها و سرویس','Configure service and variables'],['اتصال فضای دائمی /data','Attach persistent /data'],['ساخت دامنه عمومی','Generate public domain'],['شروع دیپلوی','Start deployment']];
